...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="w-48 md:min-h-screen md:border-r border-highlight md:static md:w-48 dark:bg-secondary bg-white hidden md:flex">
      ...
      {menuOpen && (
        <nav className="w-full dark:bg-secondary bg-white border-t md:border-r border-highlight md:hidden">
          <div className="flex flex-col justify-between pl-5 h-screen sticky top-0 dark:text-custom-gray text-primary font-mono">
            <ul>
              <li className="mb-8">
                <Link to="/">
